...
| Jul 22 (Wed) | 20h | 111h | EPREL crawler v2 rewrite |
| **Jul 23–25** | **—** | **111h** | **Exams — no work** |
| Jul 26 (Sun) | 15h | 126h | Category-specific edge cases |
| Jul 27 (Mon) | 12h | 138h | PostgreSQL setup & migration |
| Jul 28 (Tue) | 18h | 156h | Data validation, dataset feasibility |
| Jul 29 (Wed) | 11h | 167h | Dataset annotation planning, OCR pipeline improvements |
| Jul 30 (Thu) | 8h | 175h | Image preprocessing & matching improvements |
| Jul 31 (Fri) | 16h | 191h | Test expansion & async fixes |
| Aug 1 (Sat) | 14h | 205h | Documentation v2, EPREL integration notes |
| Aug 2 (Sun) | 19h | 224h | Docker improvements, architecture decision records |
| Aug 3 (Mon) | 16h | 240h | Progress tracking, CORS, frontend DB browser (filter bar + pagination) |
| Aug 4 (Tue) | 12h | 252h | Frontend detail panel, backend filter API, eprel_id lookup |
| Aug 5 (Wed) | 18h | 270h | Symlink/root serving, documentation v3, seed cleanup, pending items audit & triage |
| Aug 6 (Thu) | 20h | 290h | Match tuning, EPREL on-demand fallback, manufacturer scraper, OCR fallback chain, test-suite event-loop fix |
| Aug 7 (Fri) | 19h | 309h | Camera capture, location metadata, EPREL fuel-type group filtering |
| Aug 8 (Sat) | 15h | 324h | German i18n, Truma generic-match suppression, frontend location accuracy fix |
| Aug 9 (Sun) | 16h | 340h | GDPR consent, documentation v4, installation year feature |
| Aug 10 (Mon) | 16h | 356h | Parser fixes, matching fix, scraper expansion, frontend UX & modal flow |
